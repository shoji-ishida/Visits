...
- (void)locationManager:(CLLocationManager *)manager didVisit:(CLVisit *)visit {
    ...
    [message appendString:[NSString stringWithFormat:@"緯：%@ 経：%@\n",latitude, longitude]];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"VisitModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"VisitModel.sqlite"];
    NSError *error = nil;
